...
use App\Repository\InscriptionVisioRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use App\Security\UserInterface;

#[ORM\Entity(repositoryClass: InscriptionVisioRepository::class)]
class InscriptionVisio
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    // Relation avec Visio (IMPORTANTE : c'est ça qui permet plusieurs inscriptions)
    #[ORM\ManyToOne(targetEntity: Visio::class, inversedBy: 'inscriptions')]
    #[ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')]
    private ?Visio $visio = null;

    // Relation optionnelle avec User MySQL (null si c'est un Permanent)
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'inscriptionsVisios')]
    ...
    public function getVisio(): ?Visio
    {
        return $this->visio;
    }

    public function setVisio(?Visio $visio): static
    {
        $this->visio = $visio;
        return $this;
    }
