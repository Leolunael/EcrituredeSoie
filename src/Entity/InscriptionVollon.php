...
use App\Repository\InscriptionVollonRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use App\Security\UserInterface;

#[ORM\Entity(repositoryClass: InscriptionVollonRepository::class)]
class InscriptionVollon
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: Vollon::class, inversedBy: 'inscriptions')]
    #[ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')]
    private ?Vollon $vollon = null;

    // Relation optionnelle avec User MySQL (null si c'est un Permanent)
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'inscriptionsVollon')]
    ...
    public function getVollon(): ?Vollon
    {
        return $this->vollon;
    }

    public function setVollon(?Vollon $vollon): static
    {
        $this->vollon = $vollon;
        return $this;
    }
