...
#[MongoDB\Document(collection: 'commentaires')]
class Commentaire
{
    #[MongoDB\Id]
    ...
    #[Assert\NotBlank(message: 'Le texte ID est requis')]
    private ?string $texteId = null;
    ...
    public function getTexteId(): ?string
    {
        return $this->texteId;
    }

    public function setTexteId(string $texteId): self
    {
